                        ...
                        <div>
                            <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 20 20"
                                ...
                                <path
                                    ...
                                    stroke="#F08080" strokeWidth="2" strokeLinecap="round"/>
                            </svg>
                        </div>
                    </div>
                    ...
                    <div className="modal-content">
                        <div className="modal-content-content">
                            ...
                            <div className="idea-modal-first-content">
                                <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24"
                                     fill="none">
                                    <path d="M13 2L3 14H12L11 22L21 10H12L13 2Z" stroke="#F08080" strokeWidth="2"
                            ...
                            <div className="idea-modal-first-content">
                                <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24"
                                    ...
                                    <path
                                        ...
                                        stroke="#F08080" strokeWidth="2" strokeLinecap="round"
                                        strokeLinejoin="round"/>
                                    <path d="M10 8L16 12L10 16V8Z" stroke="#F08080" strokeWidth="2"
                                          strokeLinecap="round"
                                          strokeLinejoin="round"/>
                                </svg>
                                <div className="idea-modal-docs">
                            ...
                            <button onClick={() => {
                                ...
                                <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 20 20"
                                    ...
                                    <path
                                        ...
                                        stroke="#F08080" strokeWidth="1.67" strokeLinecap="round"
                                        strokeLinejoin="round"/>
                                </svg>
                            </button>
                        </div>
