        ...
        <div className="header">
            <div className="header-container">
                <div className="header-left-content">
                    <img src={logoimage} alt="Logo" width="42px" height="37.305px"/>
                    <div><p>홈</p></div>
                    <div>
                        <p>내 노트</p>
